...
Determined the variables with the most predictive ability are year, region, and race. For the histogram of method by year, please remember that there are 3 instance of execution by firing squad and 3 instances of execution by hanging in the dataset. 
